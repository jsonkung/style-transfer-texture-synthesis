...
def style_transfer(content, style, num_pyramid_layers=3, patch_sizes=(33, 21, 13, 9), num_iters=3, num_irls_iters=10):
    """
...
if __name__ == "__main__":
    ...
    content_img = cv2.imread(content, cv2.IMREAD_COLOR)
